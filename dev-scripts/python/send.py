...
#SOURCE: https://www.instructables.com/RF-433-MHZ-Raspberry-Pi/
#credit to : piddlerintheroot 
...
parser = argparse.ArgumentParser(description='Sends a decimal code via a 433/315 MHz GPIO device')
...
if args.pulselength:
    ...
    pulselength = "default"
logging.info(str(args.code) + " [protocol: " + str(protocol) + ", pulselength: " + str(pulselength) + "]")
